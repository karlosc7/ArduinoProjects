...
#include <SPI.h>  // Librería Serial Port
#include <MFRC522.h>  //Librería NFC RFID
#include <MFRC522Extended.h>  //Librería NFC RFID Extendida
#define RST_PIN  9    //Pin 9 para el reset del RC522
#define SS_PIN  10   //Pin 10 para el SS (SDA) del RC522
MFRC522 mfrc522(SS_PIN, RST_PIN); ///Creamos el objeto para el RC522
LiquidCrystal lcd(7, 8, 9, 10, 11, 12); //Pines de la pantalla de LCD
